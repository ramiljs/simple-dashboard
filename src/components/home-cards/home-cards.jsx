...
function HomeCards() {
  return (
    <div className="HomeCards" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '20px 0 25px 240px' }}>
      <Stack direction="row" spacing={7}>
        <Card sx={{ width: 300, height: 200, backgroundColor: '#f2d675', borderRadius: '15px' }}>
          <CardActionArea>
            <CardContent>
              <Typography gutterBottom sx={{ fontSize: 14, color: '#000' }} color="text.secondary">
                Laptops
              </Typography>
              ...
              <ComputerOutlinedIcon sx={{ fontSize: '70px', margin: '-5px 0', display: 'flex', alignItems: 'center', justifyContent: 'center' }} />
            </CardContent>
          </CardActionArea>
        </Card>
        <Card sx={{ width: 300, height: 200, backgroundColor: '#9ec2e6', borderRadius: '15px' }}>
          <CardActionArea>
            <CardContent>
              ...
              <PhoneIphoneOutlinedIcon sx={{ fontSize: '70px', margin: '-5px 0', display: 'flex', alignItems: 'center', justifyContent: 'center' }} />
            </CardContent>
          </CardActionArea>
        </Card>
        <Card sx={{ width: 300, height: 200, backgroundColor: '#ff8085', borderRadius: '15px' }}>
          <CardActionArea>
            <CardContent>
              ...
              <HeadphonesBatteryOutlinedIcon sx={{ fontSize: '85px', margin: '-5px 0', display: 'flex', alignItems: 'center', justifyContent: 'center' }} />
            </CardContent>
          </CardActionArea>
        </Card>
      </Stack>
