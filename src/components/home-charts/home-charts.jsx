...
function HomeCharts() {
  ...
  return (
    <div className="HomeCharts">
      <Stack 
        direction="row" 
        sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '10px 0 25px 240px' }} 
        spacing={5}
      >
        <Card sx={{ width: '500px' }}>
          <CardActionArea>
        ...
        <Card sx={{ width: '500px' }}>
          <CardActionArea>
            <BarChart width={450} height={300} data={data}>
              ...
              <Legend 
                width={70} 
                wrapperStyle={{ top: 40, right: -30, backgroundColor: '#f5f5f5', border: '1px solid #d5d5d5', borderRadius: 3, lineHeight: '40px' }} 
              />
              <CartesianGrid stroke="#ccc" strokeDasharray="5 5" />
